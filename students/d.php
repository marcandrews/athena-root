...
$download['sql'] = '	(
						...
						LIMIT 1';
	if	(
		 	$download['query'] = mysql_query($download['sql'])
		...
		$layout->redirector('Download not found ...', 'The download of this set could not be found.');
	} else {
		$layout->redirector('Unauthorized ...', 'You have not purchased this NTC; ergo, you cannot download this set.');
	}
?>